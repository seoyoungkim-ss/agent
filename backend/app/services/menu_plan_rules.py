...
# "해장"은 food_vector 차원에 없어 새 키워드 목록이 필요하다. §79: "해장"이
# 이름에 없어도 통상 해장 음식으로 꼽히는 메뉴(부대찌개, 짬뽕 등)를 놓치고
# 있다는 담당자 피드백으로 잘 알려진 해장 음식 이름을 추가했다.
_HANGOVER_KEYWORDS = (
    "해장", "북엇국", "황태", "콩나물국밥", "우거지", "뼈해장국", "선지해장국",
    "부대찌개", "짬뽕", "순대국", "순댓국", "감자탕", "육개장", "뼈다귀",
    "청국장", "동태찌개", "매운탕",
)
